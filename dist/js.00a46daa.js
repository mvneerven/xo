...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"data/forms/form.js":[function(require,module,exports) {
var schema = {
  model: {
    schemas: {
    ...
    logic: function logic(context) {
      var model = context.model,
          person = model.instance.person,
          b = model.bindings;
      b.genderUnknown = !['male', 'female'].includes(person.gender);
      b.title = (b.genderUnknown ? '' : person.gender === 'male' ? 'Mr ' : 'Mrs ') + person.name.first + ' ' + person.name.last;
...
require("../data/forms/form");

function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }

function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; }

var factory = window.xo.form.factory,
    DOM = window.xo.dom,
    log = function log(ex) {
  var elm = DOM.parseHTML("<div>Error: ".concat(ex.toString(), "</div>"));
...
function _run() {
  _run = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(context) {
    var x, result;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            x = context.createForm();
            listen(x);
            _context.next = 4;
            return x.load("/data/forms/form.js");
...
function listen(x) {
  x.on(factory.events.error, function (e) {
    log(e.detail.error);
  });
}
...
},{"../data/forms/form":"data/forms/form.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
